...
function signUp(){
  var email = prompt("Please enter your email address", "email@example.com");
  document.getElementById('output-here').innerHTML = "Thanks for signing up " + email;
}

//Extra function for Lynne's button

function orangeYouGlad() {
  document.getElementById('output-here').innerHTML = "Orange you glad that you clicked that button?";
}